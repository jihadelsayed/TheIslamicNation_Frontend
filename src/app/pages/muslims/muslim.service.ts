...
export class MuslimService {
  ...
  getMuslim() {
    ...
    return this.httpClient.get('https://raw.githubusercontent.com/davidpales1/TheIslamicNation/main/json/muslim/muslim.'+this.currentLang+'.json');
  }
}
